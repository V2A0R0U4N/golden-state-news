...
const NewsBanner = () => {
  ...
  return <section id="news-banner" className="relative bg-gradient-to-r from-red-700 via-red-600 to-red-700 text-white overflow-hidden">
      {/* Background Image */}
      <div className="absolute inset-0">
        <img src="/lovable-uploads/d5359617-1efa-4391-a8a0-a04fadb732ac.png" alt="Gujarat Focus News Banner" className="w-full h-full object-cover opacity-90" />
        ...
        <div className="flex flex-col lg:flex-row items-center justify-between gap-8">
          ...
          <div className="flex items-center gap-6">
            <div className="bg-white/20 backdrop-blur-md rounded-2xl p-4 border border-white/30 shadow-2xl">
              <img src="/lovable-uploads/2a10624f-f8b7-4362-8bec-087f48ee4f32.png" alt="Gujarat Focus News Logo" className="h-16 w-auto drop-shadow-lg" />
            </div>
            <div>
          ...
          <div className="text-center lg:text-right px-0 mx-0 my-[14px] py-[5px]">
